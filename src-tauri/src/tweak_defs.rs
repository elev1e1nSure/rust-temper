...
fn build_registry() -> Vec<TweakDef> {
    vec![
        ...
        TweakDef {
            ...
            badge: Some(TweakBadge::Recommended),
            backend_keys: group(&[
                ("inventory.quickcraftdelay", "0", "0.75"),
                ("inventory.quickcraft_button_delay", "0", "0.25"),
                ("inventory.quickcraft_rebuild_delay", "0", "0.25"),
            ]),
            advanced_slider: None,
            bind: None,
        },
        ...
        TweakDef {
            ...
            badge: None,
            backend_keys: group(&[
                ("effects.maxgibdist", "150", "150"),
                ("effects.maxgibs", "0", "10"),
                ("effects.maxgiblife", "0", "60"),
                ("effects.mingiblife", "0", "30"),
            ]),
            advanced_slider: None,
            bind: None,
        },
