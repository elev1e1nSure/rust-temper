...
const QUALITY_ROWS: QualityRow[] = [
  ...
  },
  {
    ...
    description:
      "Чем выше качество, тем сложнее стрелять. Трава почти не влияет на FPS, выбирай под свой стиль игры.",
        ...
        <div className="settings-card graphics-preset-card">
          <div className="setting-row graphics-preset-header">
            <span className="setting-name">
              <span
                className="action-icon setting-name-icon"
                aria-hidden="true"
              >
                <GraphicsIcon />
              </span>
              ...
              >
                ...
                <div className="graphics-slider-wrap">
                  <div className="graphics-slider-track">
                    <div className="graphics-slider-scale">
                      <div
